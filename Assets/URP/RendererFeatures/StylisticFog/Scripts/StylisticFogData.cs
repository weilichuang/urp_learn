...
namespace StylisticFog
{
    ...
    public struct FogColorSource
    {
        ...
        [Tooltip("Color gradient.")] [DisplayOnSelectionType(ColorSelectionType.Gradient)]
        public Gradient gradient;

        [Tooltip("Custom fog color ramp.")] [DisplayOnSelectionType(ColorSelectionType.TextureRamp)]
    ...
    public struct HeightFogSettings
    {
        ...
        [Tooltip("The rate at which the thickness of the fog decays with altitude.")] [Range(0.001f, 1f)]
